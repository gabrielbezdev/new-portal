...
export default function Leis() {
  ...
  const columns = [
    ...
    { key: "tipoServico", header: "Tipo Serviço", width: 260 },
    {
      key: "status",
      header: "Status",
      width: 160,
  ...
  const data = [
    { id: 1, nome: "Leis", tipoServico: "Serviço 1", status: "Ativo" },
    { id: 1, nome: "Leis 2", tipoServico: "Serviço 2", status: "Inativo" },
  ];
      ...
      <div className="page-titlebar">
        <PageToolbar
          ...
          buttons={[
            ...
            { label: "Nova Lei", onClick: handleNovaRenitencia },
          ]}
        />
      </div>
