...
export default function Tabulacao() {
  ...
  const data = [
    { id: 1, nome: "Tabulação Padrão", status: "Ativo" },
    { id: 1, nome: "Tabulação Padrão 2", status: "Inativo" },
  ];
      ...
      <div className="page-titlebar">
        <PageToolbar
          ...
          buttons={[
            ...
            { label: "Nova Tabulação", onClick: handleNovaRenitencia },
          ]}
        />
      </div>
